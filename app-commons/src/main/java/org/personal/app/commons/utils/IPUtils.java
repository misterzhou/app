...
public class IPUtils {
    ...
    public static Map<String, String> getLocalIps() {
        try {
            ...
            AppLogger.error("getLocalIP error", e);
    ...
    public static String getRealIpAddr(HttpServletRequest request) {
        ...
        AppLogger.debug("x-forwarded-for:" + request.getHeader("x-forwarded-for") +
    ...
    public static int ipToInt(final String address, final boolean isSegment) {
        ...
        try {
            ...
            AppLogger.warn("Warn ipToInt address is wrong: address=" + address);
        }
